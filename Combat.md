...
- **Help:** Assist another creature in performing an action.  If the action aligns with your **Class** or **[Background](optional/Background.md)** the acting creature gains +2 to their action.  If the action doesn't align with your class or [background](optional/Background.md), you can still Help if the action is in service to one of your **Passions**, but you must pay 1 **Fortune Point** to render assistance.
