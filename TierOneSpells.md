...
## Mage Lock
- **Tier:** 1st (3+)
- **Runes:** Earth, Ice, Order or Plant (depending on the "construction" of the lock)
- **Casting Ability:** Intelligence
- **Casting Time:** 1 action
- **Range:** Touch
...
- **Tier:** 1st (3+)
- **Runes:** Beast, Plant or Water (depending on food/drink type)
- **Casting Ability:** Wisdom
- **Casting Time:** 1 minute
- **Range:** Near
- **Area:** Large
...
## Resist Element
- **Tier:** 1st (3+)
- **Runes:** Elemental rune(s) matching the element(s) to be resisted or the opposing elemental rune
- **Casting Ability:** Wisdom
