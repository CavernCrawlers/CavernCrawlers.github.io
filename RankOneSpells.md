...
**Duration:** 1 day<br/>
**Save:** none<br/>
The caster touches a portal or singular object to set a magical alarm on it.  For the spell's duration, the caster will be magcially aware of any creature passing through the portal or touching the object.

Increasing the rank of the spell increases the number of objects that may be affected by +1 object per +1 rank.
...
Casting this spell at a higher rank allows the caster to increase the number of creatures affected by +1 per +1 rank or double the duration per +1 rank.
...
Casting this spell at a higher rank increases the number of target creatures by 1 per +1 Rank.
...
**Save:** none<br/>
By casting this spell and touching a weapon, that weapon will count as magical for the purposes of overcoming immunities and resistances.

Casting the spell at a higher rank increases the duration by +10 minutes per +1 rank.
...
This spell's range may be increased to Far for +1 Rank.

This spell's duration may be increased by 10 minutes per +1 Rank.

This spell's area of effect may be doubled per +1 Rank.
...
By casting this spell at higher Ranks, additional effects may be added:
- Rank 2 - cancel the following conditions: blinded, deafened, exhausted (1 level), intoxicated, paralyzed, poisoned or stunned.
- Rank 3 - cancel the following conditions: incapacitated, unconscious; heal the following lingering injuries: minor concussion, sprain, bruised ribs
- Rank 4 - cancel the petrified condition
...
**Casting Time:** 1 action<br/>
**Range:** Touch<br/>
**Area:** 1 door/gate/window/etc.<br/>
**Duration:** 1 minute<br/>
**Save:** none<br/>
By use of this spell, a mage uses their power to seal a door, gate or similar closed portal.  The portal may still be forced with a **Strength** or **Lockpicking** check with a **DT** equal to the spell's **Saving Throw DT**.

Casting this spell at a higher rank doubles the duration per +1 rank.
...
**Duration:** instant<br/>
**Save:** none<br/>
This purification ritual causes all food and drink within the affected area to be instantly cleansed of all natural contamination or spoilage (magical contaminations remain in effect).
...
**Duration:** 1 minute<br/>
**Save:** none<br/>
When this spell is learned, it is learned for a specific element (acid, cold, fire, lightning, necrotic, spirit, radiant or thunder).  The recipient gains **resistance** to that type of damage for the spell's duration.

Increasing the spell's rank may be used to produce one of the following effects:
- Increase the number of creatures affected by +1 per Rank.
- Increase the number of elements resisted by +1 per Rank (only if the caster knows the proper versions of this spell).
...
**Duration:** 10 minutes<br/>
**Save:** none<br/>
This spell conjures a shimmering barrier of magical energy between the caster and her foes.  For the duration of the spell, the caster gains +3 AC.
...
**Duration:** 10 minutes<br/>
**Save:** Hardiness<br/>
This spell forces the target creature into a magical slumber, rendering them [Unconscious](Combat.md#Unconcious).  If the slumbering creature is harmed in any way, they automatically awaken.  If more gentile means are used (such as shaking or slapping), the sleeping creature may make a new Saving Throw, but no more than once per Turn.

Casting this spell at a higher rank increases the number of targets by +1 creature per +1 Rank.
